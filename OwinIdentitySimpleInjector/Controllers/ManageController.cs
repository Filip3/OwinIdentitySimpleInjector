...
namespace OwinIdentitySimpleInjector.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(IApplicationUserManager userManager, ApplicationSignInManager signInManager, ISmsService smsService)
        {
        ...
        public async Task<ActionResult> AddPhoneNumber(AddPhoneNumberViewModel model)
        {
            ...
            if (UserManager.SmsServiceExtend() != null)
            {
